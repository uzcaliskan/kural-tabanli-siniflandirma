...
df.pivot_table("price", ["country", "source", "sex", "age"],aggfunc="mean").columns
...
agg_df.head()
agg_df["customer_level_based2"] = agg_df["country"].str.upper() + "_" + agg_df["source"].str.upper() + "_" + agg_df["sex"].str.upper() + "_" + agg_df["age_cat"].astype("object")
